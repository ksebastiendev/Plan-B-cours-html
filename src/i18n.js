...
const UI_TRANSLATIONS = {
  fr: {
    ...
    footerBrand: 'Plan B · Notes de cours',
    footerDescription: 'Bibliothèque de synthèses techniques Bitcoin orientées compréhension et mise en pratique.',
    footerBrowse: 'Parcourir les cours',
    footerTop: 'Retour en haut',
    footerCopyright: (year) => `© ${year} Plan B. Tous droits réservés.`,
  ...
  en: {
    ...
    footerBrand: 'Plan B · Course Notes',
    footerDescription: 'A technical Bitcoin notes library designed for clarity, structure, and practical learning.',
    footerBrowse: 'Browse courses',
    footerTop: 'Back to top',
    footerCopyright: (year) => `© ${year} Plan B. All rights reserved.`,
